...
//Challenge 1 - Add/Remove the class active to the buttons based on state //for Ingredients
...
//Challenge 2 - Render only the items selected in the ingredients board based on the state // shows the selected itemes on the chalk board.
...
function renderPrice() {
  ...
  payButton.onclick = () => {
    alert("payment successfull,order recieved")
  };
}